...
//        System.out.println(indexSecondElement);
        ...
        for(int i = indexFirstElement; i < indexSecondElement; i++) {
            ...
            int ind = firstParent.getCoordinatesArray().indexOf(sublistSecond.get(i-indexFirstElement));
        ...
        for(int i = indexFirstElement; i < indexSecondElement; i++) {
            ...
            int ind = secondParent.getCoordinatesArray().indexOf(sublistFirst.get(i-indexFirstElement));
